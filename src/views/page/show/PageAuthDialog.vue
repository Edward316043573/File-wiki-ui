...
import {getPageUserAuthList, assignPageUserAuth} from "@/api/page";
...
const initPageAuth = () => {
	...
	getPageUserAuthList(param).then((json) => {
...
const getSearchUserList = (query) => {
	...
	getUserBaseInfo({search: query}).then((json) => {
